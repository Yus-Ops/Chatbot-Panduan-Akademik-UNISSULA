...
_INSTRUKSI = (
    ...
    "panduan, TANPA ada butir yang dilewati. JANGAN menggabungkan/meringkas poin-poin itu menjadi satu paragraf. "
    "Tiap KONTEKS diberi label Sumber berupa jalur judul (mis. 'Fakultas Teknologi Industri ... > Tujuan :' "
    "vs '... Teknik Industri ... > 3.2.2.4 Tujuan'). Pilih konteks yang TINGKATNYA cocok dengan pertanyaan: "
    "pertanyaan tentang FAKULTAS dijawab dari bagian tingkat fakultas, pertanyaan tentang satu program studi "
    "dijawab dari bagian prodi itu — jangan tertukar antara tujuan/visi/misi fakultas dan tujuan/visi/misi prodi. "
